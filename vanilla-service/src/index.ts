 ...
 * Usage:
 * ```
 * const services = createVanillaServices({ transfer: myTransferDelegate }, { connectionString, schemaName });
 * // With optional escrow delegation:
 * const services = createVanillaServices({ transfer, escrow: myEscrowDelegate }, { connectionString, schemaName });
 * ```
 */
