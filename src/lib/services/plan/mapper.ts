...
// import { FinAPIComponents } from '@owneraio/finp2p-client';
import { ValidationError } from '../errors';


// export const assetFromAPI = (asset: FinAPIComponents['schemas']['asset']): Asset => {
//   switch (asset.type) {
//     case 'finp2p':
...
// };
//
// const legFromAssetOrder = (order: FinAPIComponents['schemas']['assetOrder']): Leg => {
...
// };
//
// const legFromAssetOrderOpt = (order?: FinAPIComponents['schemas']['assetOrder']): Leg | undefined => {
//   if (!order) {
//     return undefined;
//   }
...
// };
//
// const legFromLoanOrder = (order: FinAPIComponents['schemas']['loanOrder']): Leg => {
//   const { term, instruction } = order;
//   if (!term) {
//     throw new ValidationError('No term in order');
//   }
...
// };
//
// const legFromLoanOrderOpt = (order?: FinAPIComponents['schemas']['loanOrder']): Leg | undefined => {
//   if (!order) {
//     return undefined;
//   }
...
//
//
// export const executionFromAPI = (plan: FinAPIComponents['schemas']['executionPlan']): ExecutionPlan => {
//   const {
//     id,
