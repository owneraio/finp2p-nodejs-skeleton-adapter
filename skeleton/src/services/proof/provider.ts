...
import { DOMAIN_TYPE, RECEIPT_PROOF_TYPES, Receipt, ValidationError } from '../../models';
...
export class ProofProvider {
  ...
  constructor(orgId: string, finP2PClient: FinP2PClient | undefined, signerPrivateKey: string) {
    this.orgId = orgId;
